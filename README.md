...
4. End-to-End Application Dossier & PDF Generator: Summarizes the complete journey 
   into an official A4 Government Dossier with instant 1-click PDF printing.
5. Real-Time 5-Stage Tracking Portal: Tracks status from Submission -> Verification -> 
   Docs Approved -> Sanctioned -> DBT Disbursement with an audit trail.
6. Officer Admin Console: Enables officers to adjust income ceiling policies and 
   advance or sanction citizen dossiers live.
7. Strict Authentication Gating: Protects citizen eligibility, calculators, and tracking 
